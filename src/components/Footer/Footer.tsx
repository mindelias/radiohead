      ...
      <div className='footer-wrapper'>
        <div className='ms-3'>
          ...
          <div className='row  justify-content-between'>
            <FadeInComponentWhenVisible className='col-lg-4   mt-4'>
            ...
            <FadeInComponentWhenVisible className='col-xl-6 col-lg-7 offset-xl-2  offset-lg-1 row  m-0 p-0 justify-content-start my-4  '>
