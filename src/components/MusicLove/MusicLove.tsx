...
const MusicLove = () => {
  ...
  return (
    <div className='music-love-wrapper'>
      <FadeInComponentWhenVisible className='row justify-content-between  align-items-center my-4'>
      ...
      <FadeInComponentWhenVisible className='row justify-content-center m-0 p-0  align-items-center mt-5 '>
